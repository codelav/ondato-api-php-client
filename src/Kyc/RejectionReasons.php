...
final class RejectionReasons
{
    ...
    const REASON_POSSIBLE_FRAUD_ATTEMPT = 11;
    const REASON_UNRELATED_PHOTO = 12;
    const REASON_MORE_THAN_ONA_PERSON = 13;
    const REASON_MISCELLANEOUS = 14;
    const REASON_EXPIRED_IDENTIFICATION = 15;
}
